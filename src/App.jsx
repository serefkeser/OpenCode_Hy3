...
import { PROVIDER_STORAGE, AI_PROVIDERS, getProviderById } from './aiProviders.js';
import { LOCAL_MUSIC_LIBRARY, getMusicUrlById, getMusicProxyUrl } from './localMusic.js';
...
// eager: true ile Vite build'de gerçek asset URL'lerini üretir (public/Muzik/* -> /assets/...)
